...
\begin{frame}{Plot of Fourier Series , n = 51} 

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\columnwidth]{figs/fourier_plot.png} 
  \caption*{Fig : Waveforms}
  \label{Fig1}
\end{figure}
...
\begin{frame}{NGSPICE PLOT} 

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\columnwidth]{figs/spice.png} 
  \caption*{Fig : Waveforms}
  \label{Fig1}
\end{figure}
...
\begin{frame}[fragile]{Python Code: Plottig Fourier Series}
...
ax1.set_title(f'Output Triangular Wave  (Vpp = {Vpp:.2f} V, 50 Hz)',
...
\begin{frame}[fragile]{NGSPICE CODE}
